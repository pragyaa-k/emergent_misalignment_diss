...
GEOMETRY_FILE = Path("cross_6seed_geometry_trajectory_pairwise.csv")
...
merged["ood_alignment_difference"] = (merged["alignment_i"] - merged["alignment_j"]).abs()
merged["ood_em_rate_difference"] = (merged["em_rate_i"] - merged["em_rate_j"]).abs()
merged["ood_breadth_difference"] = (merged["breadth_i"] - merged["breadth_j"]).abs()
...
make_plot(
    "update_angle_degrees",
    "ood_em_rate_difference",
    "Cross-seed ΔW angle (degrees)",
    "Difference in out-of-domain EM rate (percentage points)",
    "Full-update similarity vs out-of-domain EM similarity",
    "update_angle_vs_ood_em_difference.png",
)
...
make_plot(
    ...
    "Cross-seed ΔW angle (degrees)",
    "Difference in out-of-domain alignment score",
    "Full-update similarity vs out-of-domain alignment similarity",
    "update_angle_vs_ood_alignment_difference.png",
)